            ...
            data=[
                {
                    ...
                    'username': 'bbehjachib',
                    'email': 'cadfabfehe',
                    'hashed_password': 'dgiiaaijj',
                },
                {
                    # data to create a User record
                    'username': 'bfaiacjjfc',
                    'email': 'eigcfgbif',
                    'hashed_password': 'bagcfbhiig',
                },
            ],
...
class FileActions(Generic[_PrismaModelT]):
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second File record ordered by the content field
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group File records by content values
        # and count how many records are in each group
